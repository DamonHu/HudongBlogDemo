...
func UIColorFromRGB(rgbValue:Int) -> UIColor {
    if #available(iOS 10.0, *) {
        return UIColor(displayP3Red: CGFloat(((Float)((rgbValue & 0xFF0000) >> 16))/255.0), green: CGFloat(((Float)((rgbValue & 0xFF00) >> 8))/255.0), blue: CGFloat(((Float)(rgbValue & 0xFF))/255.0), alpha: 1.0)
    } else {
